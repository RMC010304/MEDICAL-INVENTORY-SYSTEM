...
namespace MIS_PROJECT
{
    public partial class UserControl3 : UserControl
    {
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            ...
            SqlCommand cmd = new SqlCommand("INSERT INTO dbo.MedicalTapes2 ([Items],[Quantity],[Exp_Date],[Added_At]) Values (@Items,@Quantity,@Exp_Date,@Added_At)", con);
        ...
        private void GetItems()
        {
            ...
            SqlCommand cmd = new SqlCommand("SELECT * FROM dbo.MedicalTapes2", con);
        ...
        private void button5_Click(object sender, EventArgs e)
        {
            ...
            SqlCommand cmd = new SqlCommand("UPDATE dbo.MedicalTapes2 set Items=@Items,Quantity=@Quantity,Exp_Date=@Exp_Date,Added_At=@Added_At WHERE Item_No=@Item_No", con);
        ...
        private void button6_Click(object sender, EventArgs e)
        {
            ...
            SqlCommand cmd = new SqlCommand("DELETE dbo.MedicalTapes2 WHERE Item_No=@Item_No", con);
        ...
        public void searchData(string valueToFind)
        {
            ...
            string searchQuery = "SELECT * FROM dbo.MedicalTapes2 WHERE (Items) LIKE '%" + valueToFind + "%'";
